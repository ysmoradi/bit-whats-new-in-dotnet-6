    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddContactsViewerSharedServices();
            ...
            services.AddScoped(c =>
            {
                ...
                // Using this registration + registrations provided in Program.cs/Startup.cs of ContactsViewer.App project,
                // you can inject HttpClient and call ContactsViewer.Api api controllers in blazor pages.
